<template>
  <v-container fluid class="px-0">
    ...
    <v-content>
      <v-col v-if="selectedSubject === null" cols="12">
    ...
    <v-footer v-if="selectedSubject !== null" fixed app inset>
    ...
    <v-navigation-drawer
      v-if="selectedSubject !== null && !['xs', 'sm'].includes($mq)"
      width="240"
      permanent
      app
      right
...
export default {
  ...
  computed: {
    ...
    isStaff() {
      return this.$store.state.auth.status.loggedIn && this.$store.state.auth.user.type === "staff"
    },
    subjects() {
